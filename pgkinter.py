                ...
                if event.key == K_BACKSPACE:
                    ...
                    try:
                        for i in paste():  # from pyClipTools
                            if i not in self.__allowedChars:
                                pass
                            else:
                                text.append(i)
                        text = ''.join(text)
...
class Label(pg.sprite.Sprite):
    def __init__(self, parent, screen, font=None, bgColour=None,
                 ...
                 bottomleft=None, bottomright=None, textalignment=None):
        super().__init__()
        self.__parent = parent
        self.__screen = screen
        ...
        for i in self.__displayText:
            if textalignment == "centre":
                self.__textRects.append(i.get_rect(centerx=(self.__rect.left +
                                                            self.__width / 2),
                                                   top=(self.__rect.top +
                                                        textGap * num)))
            elif textalignment == "right":
                self.__textRects.append(i.get_rect(right=self.__rect.right,
                                                   top=(self.__rect.top +
                                                        textGap * num)))
            else:
                self.__textRects.append(i.get_rect(left=self.__rect.left,
                                                   top=(self.__rect.top +
                                                        textGap * num)))
    ...
    def config(self, font=None, bgColour=None, textColour=None, text=None,
               width=None, height=None, textalignment=None):
        ...
        for i in self.__displayText:
            if self.__textAlignment == "centre":
                self.__textRects.append(i.get_rect(centerx=(self.__rect.left +
                                                            self.__width / 2),
                                                   top=(self.__rect.top +
                                                        textGap * num)))
            elif self.__textAlignment == "right":
                self.__textRects.append(i.get_rect(right=self.__rect.right,
                                                   top=(self.__rect.top +
                                                        textGap * num)))
            else:
